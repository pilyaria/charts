  ...
  <Space direction="vertical" size="middle" align="center">
    ...
    <Space>
      ...
      <Space direction="vertical" align="center" size="small">
        <Button type="primary" shape="round"  size="large">Обновить</Button>        
      </Space>
      <Space direction="vertical" align="center" size="small">
        <Button type="primary" shape="round"  size="large">Сбор данных</Button>        
      </Space>
      <Space direction="vertical" align="center" size="small">
        <Button type="primary" shape="round"  size="large">Печать</Button>        
      </Space>
